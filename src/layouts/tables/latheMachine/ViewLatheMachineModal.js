...
const ViewLatheMachineModal = ({ open, onClose, data }) => {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="md">
      <DialogTitle>Tokarlik Dastgohi Tafsilotlari</DialogTitle>
      <DialogContent dividers>
        <Grid container spacing={2}>
          ...
          {[
            ...
            ["Konservatsiyaga olingan sana", formatDate(data?.conservation_date)],
            ["Konservatsiya sababi", data?.conservation_reason],
            ["Tavsiyalar", data?.recommendations],
...
ViewLatheMachineModal.propTypes = {
  ...
  data: PropTypes.shape({
    ...
    conservation_date: PropTypes.string,
...
export default ViewLatheMachineModal;
