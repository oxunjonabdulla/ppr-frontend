...
const ViewPressureVesselModal = ({ open, onClose, data }) => {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="md">
      <DialogTitle>Bosim ostida sig&#39;im tafsilotlari</DialogTitle>
      <DialogContent dividers>
        <Grid container spacing={2}>
          ...
          {[
            ...
            ["Sig'im kategoriyasi", data?.category_name],
            [
              "Holati",
              <SoftBadge
                key="condition"
...
ViewPressureVesselModal.propTypes = {
...
export default ViewPressureVesselModal;
