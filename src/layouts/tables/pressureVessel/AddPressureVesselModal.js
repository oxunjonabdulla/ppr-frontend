...
function AddPressureVesselModal({ open, onClose, onSuccess }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      await axiosInstance.post("pressure_vessel-list-create/", formDataToSend);
      onSuccess();
      onClose();
    } catch (error) {
        ...
        <div className="modal-container">
          ...
          <div className="modal-content">
            <div className="form-grid">
              ...
              <label>Sig&#39;im kategoriyasi
                <input name="category_name" value={formData.category_name} onChange={handleChange} />
              </label>
